...
<button id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
    class="btn-primary p-2 border border-0 dropdown-toggle  <?= isset($page) && $page =='projects_per_curriculum' ? "active" : "" ?>">
    ...
    <div class="col-12">
        ...
        <div class="card card-outline card-primary shadow rounded-0">
            ...
            <div class="card-body rounded-0">
                ...
                <a href="javascript:void(0)" style="float:right;" class="text-navy" id="search_icon"><i
                        class="fa fa-search"></i></a>

                <div id="search-field" stlye="float:right;">
                    <input type="search" id="search-input" class="form-control rounded-0" required
                        placeholder="Search..." value="<?= isset($_GET['q']) ? $_GET['q'] : '' ?>">
                </div>

                <h2>Capstone List of <?= isset($curriculum['name']) ? $curriculum['name'] : "" ?> </h2>
