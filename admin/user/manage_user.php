            ...
            <form action="" id="manage-user">
                ...
                <div class="form-group col-6">
                    ...
                    <input type="password" name="password" id="password" class="form-control" placeholder="Password"
                        value="" autocomplete="off" <?php echo isset($meta['id']) ? "": 'required' ?>>
