...
<div class="card card-outline card-primary">
    <div class="card-header">
        ...
        <div class="card-tools">
            <a href="javascript:void(0)" id="create_new" class="btn btn-primary"><span class="fas fa-plus"></span> Add
                New College</a>
        </div>
    </div>
    <div class="card-body">
...
$(document).ready(function() {
    $('#create_new').click(function() {
        uni_modal("College Details", "departments/manage_department.php")
    })
    $('.edit_data').click(function() {
        uni_modal("College Details", "departments/manage_department.php?id=" + $(this).attr(
            'data-id'))
    })
    $('.delete_data').click(function() {
        _conf("Are you sure to delete this College permanently?", "delete_department", [$(this).attr(
            'data-id')])
    })
    $('.view_data').click(function() {
        uni_modal("College Details", "departments/view_department.php?id=" + $(this).attr('data-id'))
    })
