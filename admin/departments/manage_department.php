...
<div class="container-fluid">
    <form action="" id="department-form">
        ...
        <div class="form-group">
            <label for="name" class="control-label">College</label>
            <input type="text" name="name" id="name" class="form-control form-control-border" placeholder="College Name"
        ...
        <div class="form-group">
            ...
            <textarea rows="3" name="description" id="description" class="form-control form-control-border"
                placeholder="Write the College description here."
