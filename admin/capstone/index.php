...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h3 class="card-title">List of Capstone</h3>
    </div>
    <div class="card-body">
            ...
            <div class="container-fluid">
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
						...
						$qry = $conn->query("SELECT * from `archive_list` where status = 0  order by `year` desc, `title` desc ");
                                ...
                                <div class="dropdown-menu" role="menu">
                                    ...
                                    <a class="dropdown-item update_status" href="javascript:void(0)"
                                        ...
                                        data-status="<?php echo $row['status'] ?>"><span
                                            class="fa fa-check text-dark"></span>Recommend</a>
                                    <div class="dropdown-divider"></div>
...
$(document).ready(function() {
    ...
    $('.update_status').click(function() {
        uni_modal("Recommend Capstone", "capstone/update_status.php?id=" + $(this).attr('data-id') +
