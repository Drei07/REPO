...
$(document).ready(function() {
    ...
    $('.edit_data').click(function() {
        uni_modal("Program Details", "curriculum/manage_curriculum.php?id=" + $(this).attr(
            'data-id'))
    })
    $('.delete_data').click(function() {
        _conf("Are you sure to delete this Curriculum permanently?", "delete_curriculum", [$(this).attr(
            'data-id')])
    })
    $('.view_data').click(function() {
        uni_modal("Program Details", "curriculum/view_curriculum.php?id=" + $(this).attr('data-id'))
    })
