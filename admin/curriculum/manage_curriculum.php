...
<div class="container-fluid">
    <form action="" id="curriculum-form">
        ...
        <div class="form-group">
            <label for="department_id" class="control-label">College</label>
            <select name="department_id" id="department_id" class="form-control form-control-border" required
                data-placeholder="Select College Here">
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" id="name" class="form-control form-control-border" placeholder="Program Name"
        ...
        <div class="form-group">
            ...
            <textarea rows="3" name="description" id="description" class="form-control form-control-border"
                placeholder="Write the Program description here."
