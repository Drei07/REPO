...
<button id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
    class="btn-primary p-2 border border-0 dropdown-toggle  <?= isset($page) && $page =='projects_per_department' ? "active" : "" ?>">Select
    College</button>
    ...
    <div class="col-12">
        <div class="card card-outline card-primary shadow rounded-0">
            <div class="card-body rounded-0">
                <h2>Capstone List of <?= isset($department['name']) ? $department['name'] : "" ?> </h2>
