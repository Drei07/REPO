            ...
            <div class="container-fluid">
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
						...
						$qry = $conn->query("SELECT * from `archive_list` where status = 3 order by `year` desc, `title` desc ");
                                ...
                                <div class="dropdown-menu" role="menu">
                                    ...
                                    <a class="dropdown-item update_status" href="javascript:void(0)"
                                        ...
                                        data-status="<?php echo $row['status'] ?>"><span
                                            class="fa fa-check text-dark"></span>Approve</a>
                                    <div class="dropdown-divider"></div>
...
$(document).ready(function() {
    ...
    $('.update_status').click(function() {
        uni_modal("Capstone Details", "approved/update_status.php?id=" + $(this).attr('data-id') +
