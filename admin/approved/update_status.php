<div class="container-fluid">
    <form action="" id="update_status_form">
        ...
        <div class="form-group">
            <label for="status" class="control-label text-navy">Do you want to approve this Capstone?</label>
            <select name="status" id="status" class="form-control form-control-border" required>
                <option value="4" <?= isset($_GET['status']) && $_GET['status'] == 4 ? "selected" : "" ?>>Approved
                </option>
