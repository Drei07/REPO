    ...
    <div class="h-100 d-flex  align-items-center w-100" id="login">
        <div class="col-7 h-100 d-flex align-items-center justify-content-center">
            <div class="w-100">
                ...
                <h1 style="color:black;" class="text-center py-2 fw-bold"><b><?php echo $_settings->info('name') ?></b>
                </h1>
                <h3 class="text-center"><?php echo $_settings->info('address') ?></h3>
            </div>
        ...
        <div class="col-5 h-100 bg-gradient bg-primary">
            <div class="w-100 d-flex justify-content-center align-items-center h-100 text-navy">
                <div class="card card-outline card-primary p-2 rounded-1 shadow col-lg-10 col-md-10 col-sm-5">
                    <div class="card-header">
                        <h5 class="card-title text-purle"><b>Sign in</b></h5>
                    </div>
                    <div class="card-body">
